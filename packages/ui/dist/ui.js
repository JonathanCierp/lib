import { defineComponent as z, useSlots as R, computed as c, openBlock as o, createElementBlock as t, normalizeClass as m, unref as l, toDisplayString as C, mergeProps as B, createElementVNode as e, Fragment as j, renderList as X, createBlock as x, resolveDynamicComponent as D, createCommentVNode as f, renderSlot as $, createTextVNode as y, useAttrs as N, ref as Q, withCtx as K } from "vue";
var U = {}, T = {};
(function(r) {
  ...
  n.withOptions = function(u, i = () => ({})) {
    ...
    return d.__isOptionsFunction = !0, d.__pluginFunction = u, d.__configFunction = i, d;
  };
  const a = n;
})(T);
(function(r) {
...
let I = U;
var Y = (I.__esModule ? I : { default: I }).default;
const it = Y(function() {
}, {
  content: [],
  theme: {
  ...
  props: {
    ...
    roundedFull: { type: Boolean, default: !0 },
    size: { default: "md" }
  },
  setup(r) {
    const n = r, a = R(), u = c(
      () => n.placeholder ? " bg-gray-100 dark:bg-gray-600" : ""
    ), i = c(() => n.rounded ? "rounded" : ""), d = c(
      () => n.roundedFull ? "rounded-full" : ""
    ), h = c(() => n.size ? L[n.size].base : ""), s = c(
      () => n.size ? L[n.size].placeholder : ""
    ), w = c(
      () => n.size ? L[n.size].letters : ""
    ), M = c(() => {
      var g, p;
      if (a.default && ((g = a.default()[0].children) == null ? void 0 : g.toString())) {
        const v = a.default ? ((p = a.default()[0].children) == null ? void 0 : p.toString().split(" ").filter((_) => !!_)) || [] : [];
        return (v == null ? void 0 : v.length) > 1 ? `${v[0][0]}${v[1][0]}` : v[0][0];
      }
      return "";
    });
    return (g, p) => (o(), t("div", {
      class: m([[l(u), l(h), l(i), l(d)], "overflow-hidden relative border-2 border-white dark:border-gray-800"])
    }, [
      r.placeholder ? (o(), t("svg", {
        key: 0,
        class: m([[l(s), l(i), l(d)], "absolute -left-1 text-gray-400"]),
        fill: "currentColor",
        viewBox: "0 0 20 20",
        xmlns: "http://www.w3.org/2000/svg"
      }, J, 2)) : g.$slots.default && l(M) ? (o(), t("span", {
        key: 1,
        class: m([[l(w)], "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-medium"])
      }, C(l(M)), 3)) : (o(), t("img", B({
        key: 2,
        class: [l(h), l(i), l(d)]
      }, g.$attrs), null, 16))
  ...
  setup(r) {
    const n = r, a = R(), u = c(() => {
      if (a.default) {
        const d = a.default().filter((h) => h.type.__name === "BaseAvatar").map((h) => ({
          name: h.type.__name,
          props: h.props
        }));
        return {
          originalItems: d,
          items: d.slice(0, n.max)
        };
      }
      return {
        originalItems: [],
      ...
      if (a.default) {
        const d = u.value.originalItems.length - n.max;
        return n.total > 0 ? n.total : d;
      }
      return 0;
    });
    return (d, h) => (o(), t("div", r0, [
      (o(!0), t(j, null, X(l(u).items, (s, w) => (o(), x(D(s.name), B({
        key: `${s.name} ${w}`
      }, s.props), null, 16))), 128)),
      l(i) > 0 ? (o(), t("a", n0, " +" + C(l(i)), 1)) : f("", !0)
    ]));
  }
});
var q = /* @__PURE__ */ ((r) => (r.top = "top", r.top_right = "top_right", r.right = "right", r.bottom_right = "bottom_right", r.bottom = "bottom", r.bottom_left = "bottom_left", r.left = "left", r.top_left = "top_left", r))(q || {});
const S = {
  top: {
    base: "top-0",
    rounded: {
...
var G = /* @__PURE__ */ ((r) => (r.default = "default", r.success = "success", r.error = "error", r.info = "info", r.warning = "warning", r))(G || {});
const t0 = {
  default: {
...
}, a0 = { class: "relative" }, l0 = /* @__PURE__ */ z({
  __name: "BaseBadge",
  props: {
    modelValue: null,
    position: { default: q.top_right },
    color: { default: G.default },
    dot: { type: Boolean, default: !1 },
    invisible: { type: Boolean, default: !1 },
    showZero: { type: Boolean, default: !1 },
    max: { default: 99 },
    overlap: { default: "square" }
  },
  setup(r) {
    const n = r, a = c(
      () => `${S[n.position].base} ${S[n.position][n.overlap][n.dot ? "dot" : "base"]}`
    ), u = c(() => t0[n.color].base), i = c(() => n.dot ? "w-3 h-3" : "w-5 h-5"), d = c(() => n.invisible || !isNaN(n.modelValue) && (+n.modelValue == 0 || !n.modelValue) && !n.showZero ? "scale-0" : "scale-100"), h = c(
      () => !isNaN(n.modelValue) && +n.modelValue > n.max ? `${n.max}+` : n.modelValue
    );
    return (s, w) => (o(), t("div", a0, [
      $(s.$slots, "default"),
      e("span", {
        class: m(["flex items-center justify-center absolute border-white dark:border-gray-800 rounded-full border-2 text-xs transform", [l(u), l(d), l(a), l(i)]])
      }, [
        n.dot ? f("", !0) : $(s.$slots, "content", { key: 0 }, () => [
          y(C(l(h)), 1)
        ])
      ], 2)
    ]));
...
function h0(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M3.375 3C2.339 3 1.5 3.84 1.5 4.875v.75c0 1.036.84 1.875 1.875 1.875h17.25c1.035 0 1.875-.84 1.875-1.875v-.75C22.5 3.839 21.66 3 20.625 3H3.375z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function U0(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M9.97.97a.75.75 0 011.06 0l3 3a.75.75 0 01-1.06 1.06l-1.72-1.72v3.44h-1.5V3.31L8.03 5.03a.75.75 0 01-1.06-1.06l3-3zM9.75 6.75v6a.75.75 0 001.5 0v-6h3a3 3 0 013 3v7.5a3 3 0 01-3 3h-7.5a3 3 0 01-3-3v-7.5a3 3 0 013-3h3z" }),
    e("path", { d: "M7.151 21.75a2.999 2.999 0 002.599 1.5h7.5a3 3 0 003-3v-7.5c0-1.11-.603-2.08-1.5-2.599v7.099a4.5 4.5 0 01-4.5 4.5H7.151z" })
  ]);
}
function T0(r, n) {
...
function o5(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M12 7.5a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function w5(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M4.5 9.75a.75.75 0 00-.75.75V15c0 .414.336.75.75.75h6.75A.75.75 0 0012 15v-4.5a.75.75 0 00-.75-.75H4.5z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function p5(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M5.85 3.5a.75.75 0 00-1.117-1 9.719 9.719 0 00-2.348 4.876.75.75 0 001.479.248A8.219 8.219 0 015.85 3.5zM19.267 2.5a.75.75 0 10-1.118 1 8.22 8.22 0 011.987 4.124.75.75 0 001.48-.248A9.72 9.72 0 0019.266 2.5z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function m5(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M3.53 2.47a.75.75 0 00-1.06 1.06l18 18a.75.75 0 101.06-1.06l-18-18zM20.57 16.476c-.223.082-.448.161-.674.238L7.319 4.137A6.75 6.75 0 0118.75 9v.75c0 2.123.8 4.057 2.118 5.52a.75.75 0 01-.297 1.206z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function $5(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M11.584 2.376a.75.75 0 01.832 0l9 6a.75.75 0 11-.832 1.248L12 3.901 3.416 9.624a.75.75 0 01-.832-1.248l9-6z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function L5(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M5.223 2.25c-.497 0-.974.198-1.325.55l-1.3 1.298A3.75 3.75 0 007.5 9.75c.627.47 1.406.75 2.25.75.844 0 1.624-.28 2.25-.75.626.47 1.406.75 2.25.75.844 0 1.623-.28 2.25-.75a3.75 3.75 0 004.902-5.652l-1.3-1.299a1.875 1.875 0 00-1.325-.549H5.223z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function S5(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M12 9a3.75 3.75 0 100 7.5A3.75 3.75 0 0012 9z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function q5(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M4.913 2.658c2.075-.27 4.19-.408 6.337-.408 2.147 0 4.262.139 6.337.408 1.922.25 3.291 1.861 3.405 3.727a4.403 4.403 0 00-1.032-.211 50.89 50.89 0 00-8.42 0c-2.358.196-4.04 2.19-4.04 4.434v4.286a4.47 4.47 0 002.433 3.984L7.28 21.53A.75.75 0 016 21v-4.03a48.527 48.527 0 01-1.087-.128C2.905 16.58 1.5 14.833 1.5 12.862V6.638c0-1.97 1.405-3.718 3.413-3.979z" }),
...
function a1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M21 6.375c0 2.692-4.03 4.875-9 4.875S3 9.067 3 6.375 7.03 1.5 12 1.5s9 2.183 9 4.875z" }),
    e("path", { d: "M12 12.75c2.685 0 5.19-.586 7.078-1.609a8.283 8.283 0 001.897-1.384c.016.121.025.244.025.368C21 12.817 16.97 15 12 15s-9-2.183-9-4.875c0-.124.009-.247.025-.368a8.285 8.285 0 001.897 1.384C6.809 12.164 9.315 12.75 12 12.75z" }),
    e("path", { d: "M12 16.5c2.685 0 5.19-.586 7.078-1.609a8.282 8.282 0 001.897-1.384c.016.121.025.244.025.368 0 2.692-4.03 4.875-9 4.875s-9-2.183-9-4.875c0-.124.009-.247.025-.368a8.284 8.284 0 001.897 1.384C6.809 15.914 9.315 16.5 12 16.5z" }),
...
function i1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M3 8.625c0-1.036.84-1.875 1.875-1.875h.375A3.75 3.75 0 019 10.5v1.875c0 1.036.84 1.875 1.875 1.875h1.875A3.75 3.75 0 0116.5 18v2.625c0 1.035-.84 1.875-1.875 1.875h-9.75A1.875 1.875 0 013 20.625v-12z" }),
...
function z1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M4.5 3.75a3 3 0 00-3 3v.75h21v-.75a3 3 0 00-3-3h-15z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function B1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M10.464 8.746c.227-.18.497-.311.786-.394v2.795a2.252 2.252 0 01-.786-.393c-.394-.313-.546-.681-.546-1.004 0-.323.152-.691.546-1.004zM12.75 15.662v-2.824c.347.085.664.228.921.421.427.32.579.686.579.991 0 .305-.152.671-.579.991a2.534 2.534 0 01-.921.42z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function j1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M10.5 18.75a.75.75 0 000 1.5h3a.75.75 0 000-1.5h-3z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function y1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M10.5 18a.75.75 0 000 1.5h3a.75.75 0 000-1.5h-3z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function E1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M7.5 3.375c0-1.036.84-1.875 1.875-1.875h.375a3.75 3.75 0 013.75 3.75v1.875C13.5 8.161 14.34 9 15.375 9h1.875A3.75 3.75 0 0121 12.75v3.375C21 17.16 20.16 18 19.125 18h-9.75A1.875 1.875 0 017.5 16.125V3.375z" }),
...
function R1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M11.625 16.5a1.875 1.875 0 100-3.75 1.875 1.875 0 000 3.75z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function G1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M5.625 1.5c-1.036 0-1.875.84-1.875 1.875v17.25c0 1.035.84 1.875 1.875 1.875h12.75c1.035 0 1.875-.84 1.875-1.875V12.75A3.75 3.75 0 0016.5 9h-1.875a1.875 1.875 0 01-1.875-1.875V5.25A3.75 3.75 0 009 1.5H5.625z" }),
    e("path", { d: "M12.971 1.816A5.23 5.23 0 0114.25 5.25v1.875c0 .207.168.375.375.375H16.5a5.23 5.23 0 013.434 1.279 9.768 9.768 0 00-6.963-6.963z" })
  ]);
}
function O1(r, n) {
...
function N1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M19.5 22.5a3 3 0 003-3v-8.174l-6.879 4.022 3.485 1.876a.75.75 0 01-.712 1.321l-5.683-3.06a1.5 1.5 0 00-1.422 0l-5.683 3.06a.75.75 0 01-.712-1.32l3.485-1.877L1.5 11.326V19.5a3 3 0 003 3h15z" }),
...
function Q1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" }),
...
function J1(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M3.53 2.47a.75.75 0 00-1.06 1.06l18 18a.75.75 0 101.06-1.06l-18-18zM22.676 12.553a11.249 11.249 0 01-2.631 4.31l-3.099-3.099a5.25 5.25 0 00-6.71-6.71L7.759 4.577a11.217 11.217 0 014.242-.827c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113z" }),
    e("path", { d: "M15.75 12c0 .18-.013.357-.037.53l-4.244-4.243A3.75 3.75 0 0115.75 12zM12.53 15.713l-4.243-4.244a3.75 3.75 0 004.243 4.243z" }),
...
function e2(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M12 15a3 3 0 100-6 3 3 0 000 6z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function f2(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M15.75 8.25a.75.75 0 01.75.75c0 1.12-.492 2.126-1.27 2.812a.75.75 0 11-.992-1.124A2.243 2.243 0 0015 9a.75.75 0 01.75-.75z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function B2(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M19.006 3.705a.75.75 0 00-.512-1.41L6 6.838V3a.75.75 0 00-.75-.75h-1.5A.75.75 0 003 3v4.93l-1.006.365a.75.75 0 00.512 1.41l16.5-6z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function V2(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" }),
...
function S2(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M12 .75a8.25 8.25 0 00-4.135 15.39c.686.398 1.115 1.008 1.134 1.623a.75.75 0 00.577.706c.352.083.71.148 1.074.195.323.041.6-.218.6-.544v-4.661a6.714 6.714 0 01-.937-.171.75.75 0 11.374-1.453 5.261 5.261 0 002.626 0 .75.75 0 11.374 1.452 6.712 6.712 0 01-.937.172v4.66c0 .327.277.586.6.545.364-.047.722-.112 1.074-.195a.75.75 0 00.577-.706c.02-.615.448-1.225 1.134-1.623A8.25 8.25 0 0012 .75z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function U2(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M8.25 10.875a2.625 2.625 0 115.25 0 2.625 2.625 0 01-5.25 0z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function N2(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M8.25 4.5a3.75 3.75 0 117.5 0v8.25a3.75 3.75 0 11-7.5 0V4.5z" }),
...
function c7(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32l8.4-8.4z" }),
...
function F7(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M5.507 4.048A3 3 0 017.785 3h8.43a3 3 0 012.278 1.048l1.722 2.008A4.533 4.533 0 0019.5 6h-15c-.243 0-.482.02-.715.056l1.722-2.008z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function P7(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M4.08 5.227A3 3 0 016.979 3H17.02a3 3 0 012.9 2.227l2.113 7.926A5.228 5.228 0 0018.75 12H5.25a5.228 5.228 0 00-3.284 1.153L4.08 5.227z" }),
    e("path", {
      "fill-rule": "evenodd",
...
function Q7(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M16.5 6a3 3 0 00-3-3H6a3 3 0 00-3 3v7.5a3 3 0 003 3v-6A4.5 4.5 0 0110.5 6h6z" }),
...
function K7(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M11.644 1.59a.75.75 0 01.712 0l9.75 5.25a.75.75 0 010 1.32l-9.75 5.25a.75.75 0 01-.712 0l-9.75-5.25a.75.75 0 010-1.32l9.75-5.25z" }),
    e("path", { d: "M3.265 10.602l7.668 4.129a2.25 2.25 0 002.134 0l7.668-4.13 1.37.739a.75.75 0 010 1.32l-9.75 5.25a.75.75 0 01-.71 0l-9.75-5.25a.75.75 0 010-1.32l1.37-.738z" }),
...
function d3(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M3.375 4.5C2.339 4.5 1.5 5.34 1.5 6.375V13.5h12V6.375c0-1.036-.84-1.875-1.875-1.875h-8.25zM13.5 15h-12v2.625c0 1.035.84 1.875 1.875 1.875h.375a3 3 0 116 0h3a.75.75 0 00.75-.75V15z" }),
    e("path", { d: "M8.25 19.5a1.5 1.5 0 10-3 0 1.5 1.5 0 003 0zM15.75 6.75a.75.75 0 00-.75.75v11.25c0 .087.015.17.042.248a3 3 0 015.958.464c.853-.175 1.522-.935 1.464-1.883a18.659 18.659 0 00-3.732-10.104 1.837 1.837 0 00-1.47-.725H15.75z" }),
...
function A3(r, n) {
  return o(), t("svg", {
    ...
    e("path", { d: "M10.076 8.64l-2.201-2.2V4.874a.75.75 0 00-.364-.643l-3.75-2.25a.75.75 0 00-.916.113l-.75.75a.75.75 0 00-.113.916l2.25 3.75a.75.75 0 00.643.364h1.564l2.062 2.062 1.575-1.297z" }),
    e("path", {
      "fill-rule": "evenodd",
...
const H3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCapIcon: c0,
  AdjustmentsHorizontalIcon: i0,
  AdjustmentsVerticalIcon: d0,
  ArchiveBoxArrowDownIcon: h0,
  ArchiveBoxXMarkIcon: u0,
  ArchiveBoxIcon: s0,
  ArrowDownCircleIcon: v0,
  ArrowDownLeftIcon: w0,
  ArrowDownOnSquareStackIcon: g0,
  ArrowDownOnSquareIcon: p0,
  ArrowDownRightIcon: m0,
  ArrowDownTrayIcon: x0,
  ArrowDownIcon: f0,
  ArrowLeftCircleIcon: M0,
  ArrowLeftOnRectangleIcon: k0,
  ArrowLeftIcon: z0,
  ArrowLongDownIcon: _0,
  ArrowLongLeftIcon: C0,
  ArrowLongRightIcon: A0,
  ArrowLongUpIcon: B0,
  ArrowPathRoundedSquareIcon: V0,
  ArrowPathIcon: $0,
  ArrowRightCircleIcon: H0,
  ArrowRightOnRectangleIcon: I0,
  ArrowRightIcon: L0,
  ArrowSmallDownIcon: b0,
  ArrowSmallLeftIcon: j0,
  ArrowSmallRightIcon: y0,
  ArrowSmallUpIcon: D0,
  ArrowTopRightOnSquareIcon: S0,
  ArrowTrendingDownIcon: F0,
  ArrowTrendingUpIcon: P0,
  ArrowUpCircleIcon: E0,
  ArrowUpLeftIcon: R0,
  ArrowUpOnSquareStackIcon: U0,
  ArrowUpOnSquareIcon: T0,
  ArrowUpRightIcon: q0,
  ArrowUpTrayIcon: G0,
  ArrowUpIcon: O0,
  ArrowUturnDownIcon: W0,
  ArrowUturnLeftIcon: X0,
  ArrowUturnRightIcon: N0,
  ArrowUturnUpIcon: Q0,
  ArrowsPointingInIcon: K0,
  ArrowsPointingOutIcon: Y0,
  ArrowsRightLeftIcon: Z0,
  ArrowsUpDownIcon: J0,
  AtSymbolIcon: e5,
  BackspaceIcon: r5,
  BackwardIcon: n5,
  BanknotesIcon: o5,
  Bars2Icon: t5,
  Bars3BottomLeftIcon: a5,
  Bars3BottomRightIcon: l5,
  Bars3CenterLeftIcon: c5,
  Bars3Icon: i5,
  Bars4Icon: d5,
  BarsArrowDownIcon: h5,
  BarsArrowUpIcon: u5,
  Battery0Icon: s5,
  Battery100Icon: v5,
  Battery50Icon: w5,
  ...
  BoltIcon: k5,
  BookOpenIcon: z5,
  BookmarkSlashIcon: _5,
  BookmarkSquareIcon: C5,
  BookmarkIcon: A5,
  BriefcaseIcon: B5,
  BugAntIcon: V5,
  BuildingLibraryIcon: $5,
  BuildingOffice2Icon: H5,
  BuildingOfficeIcon: I5,
  BuildingStorefrontIcon: L5,
  CakeIcon: b5,
  CalculatorIcon: j5,
  CalendarDaysIcon: y5,
  CalendarIcon: D5,
  CameraIcon: S5,
  ChartBarSquareIcon: F5,
  ChartBarIcon: P5,
  ChartPieIcon: E5,
  ChatBubbleBottomCenterTextIcon: R5,
  ChatBubbleBottomCenterIcon: U5,
  ChatBubbleLeftEllipsisIcon: T5,
  ChatBubbleLeftRightIcon: q5,
  ChatBubbleLeftIcon: G5,
  ChatBubbleOvalLeftEllipsisIcon: O5,
  ChatBubbleOvalLeftIcon: W5,
  CheckBadgeIcon: X5,
  CheckCircleIcon: N5,
  CheckIcon: Q5,
  ChevronDoubleDownIcon: K5,
  ChevronDoubleLeftIcon: Y5,
  ChevronDoubleRightIcon: Z5,
  ChevronDoubleUpIcon: J5,
  ChevronDownIcon: e1,
  ChevronLeftIcon: r1,
  ChevronRightIcon: n1,
  ChevronUpDownIcon: o1,
  ChevronUpIcon: t1,
  CircleStackIcon: a1,
  ClipboardDocumentCheckIcon: l1,
  ClipboardDocumentListIcon: c1,
  ClipboardDocumentIcon: i1,
  ClipboardIcon: d1,
  ClockIcon: h1,
  CloudArrowDownIcon: u1,
  CloudArrowUpIcon: s1,
  CloudIcon: v1,
  CodeBracketSquareIcon: w1,
  CodeBracketIcon: g1,
  Cog6ToothIcon: p1,
  Cog8ToothIcon: m1,
  CogIcon: x1,
  CommandLineIcon: f1,
  ComputerDesktopIcon: M1,
  CpuChipIcon: k1,
  CreditCardIcon: z1,
  CubeTransparentIcon: _1,
  CubeIcon: C1,
  CurrencyBangladeshiIcon: A1,
  CurrencyDollarIcon: B1,
  CurrencyEuroIcon: V1,
  CurrencyPoundIcon: $1,
  CurrencyRupeeIcon: H1,
  CurrencyYenIcon: I1,
  CursorArrowRaysIcon: L1,
  CursorArrowRippleIcon: b1,
  DevicePhoneMobileIcon: j1,
  DeviceTabletIcon: y1,
  DocumentArrowDownIcon: D1,
  DocumentArrowUpIcon: S1,
  DocumentChartBarIcon: F1,
  DocumentCheckIcon: P1,
  DocumentDuplicateIcon: E1,
  DocumentMagnifyingGlassIcon: R1,
  DocumentMinusIcon: U1,
  DocumentPlusIcon: T1,
  DocumentTextIcon: q1,
  DocumentIcon: G1,
  EllipsisHorizontalCircleIcon: O1,
  EllipsisHorizontalIcon: W1,
  EllipsisVerticalIcon: X1,
  EnvelopeOpenIcon: N1,
  EnvelopeIcon: Q1,
  ExclamationCircleIcon: K1,
  ...
  GiftIcon: p2,
  GlobeAltIcon: m2,
  GlobeAmericasIcon: x2,
  GlobeAsiaAustraliaIcon: f2,
  GlobeEuropeAfricaIcon: M2,
  HandRaisedIcon: k2,
  HandThumbDownIcon: z2,
  HandThumbUpIcon: _2,
  HashtagIcon: C2,
  HeartIcon: A2,
  HomeModernIcon: B2,
  HomeIcon: V2,
  IdentificationIcon: $2,
  InboxArrowDownIcon: H2,
  InboxStackIcon: I2,
  InboxIcon: L2,
  InformationCircleIcon: b2,
  KeyIcon: j2,
  LanguageIcon: y2,
  LifebuoyIcon: D2,
  LightBulbIcon: S2,
  ...
  LockClosedIcon: E2,
  LockOpenIcon: R2,
  MagnifyingGlassCircleIcon: U2,
  MagnifyingGlassMinusIcon: T2,
  MagnifyingGlassPlusIcon: q2,
  MagnifyingGlassIcon: G2,
  MapPinIcon: O2,
  MapIcon: W2,
  MegaphoneIcon: X2,
  MicrophoneIcon: N2,
  ...
  NoSymbolIcon: r7,
  PaintBrushIcon: n7,
  PaperAirplaneIcon: o7,
  PaperClipIcon: t7,
  PauseCircleIcon: a7,
  PauseIcon: l7,
  PencilSquareIcon: c7,
  PencilIcon: i7,
  PhoneArrowDownLeftIcon: d7,
  PhoneArrowUpRightIcon: h7,
  PhoneXMarkIcon: u7,
  PhoneIcon: s7,
  PhotoIcon: v7,
  PlayCircleIcon: w7,
  ...
  PlusIcon: f7,
  PowerIcon: M7,
  PresentationChartBarIcon: k7,
  PresentationChartLineIcon: z7,
  PrinterIcon: _7,
  PuzzlePieceIcon: C7,
  QrCodeIcon: A7,
  QuestionMarkCircleIcon: B7,
  QueueListIcon: V7,
  RadioIcon: $7,
  ReceiptPercentIcon: H7,
  ReceiptRefundIcon: I7,
  RectangleGroupIcon: L7,
  RectangleStackIcon: b7,
  RocketLaunchIcon: j7,
  RssIcon: y7,
  ScaleIcon: D7,
  ScissorsIcon: S7,
  ...
  UsersIcon: p3,
  VariableIcon: m3,
  VideoCameraSlashIcon: x3,
  VideoCameraIcon: f3,
  ViewColumnsIcon: M3,
  ViewfinderCircleIcon: k3,
  WalletIcon: z3,
  WifiIcon: _3,
  WindowIcon: C3,
  WrenchScrewdriverIcon: A3,
  WrenchIcon: B3,
  XCircleIcon: V3,
  XMarkIcon: $3
...
const et = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCapIcon: I3,
  AdjustmentsHorizontalIcon: L3,
  AdjustmentsVerticalIcon: b3,
  ArchiveBoxArrowDownIcon: j3,
  ArchiveBoxXMarkIcon: y3,
  ArchiveBoxIcon: D3,
  ArrowDownCircleIcon: S3,
  ArrowDownLeftIcon: F3,
  ArrowDownOnSquareStackIcon: P3,
  ArrowDownOnSquareIcon: E3,
  ArrowDownRightIcon: R3,
  ArrowDownTrayIcon: U3,
  ArrowDownIcon: T3,
  ArrowLeftCircleIcon: q3,
  ArrowLeftOnRectangleIcon: G3,
  ArrowLeftIcon: O3,
  ArrowLongDownIcon: W3,
  ArrowLongLeftIcon: X3,
  ArrowLongRightIcon: N3,
  ArrowLongUpIcon: Q3,
  ArrowPathRoundedSquareIcon: K3,
  ArrowPathIcon: Y3,
  ArrowRightCircleIcon: Z3,
  ArrowRightOnRectangleIcon: J3,
  ArrowRightIcon: ee,
  ArrowSmallDownIcon: re,
  ArrowSmallLeftIcon: ne,
  ArrowSmallRightIcon: oe,
  ArrowSmallUpIcon: te,
  ArrowTopRightOnSquareIcon: ae,
  ArrowTrendingDownIcon: le,
  ArrowTrendingUpIcon: ce,
  ArrowUpCircleIcon: ie,
  ArrowUpLeftIcon: de,
  ArrowUpOnSquareStackIcon: he,
  ArrowUpOnSquareIcon: ue,
  ArrowUpRightIcon: se,
  ArrowUpTrayIcon: ve,
  ArrowUpIcon: we,
  ArrowUturnDownIcon: ge,
  ArrowUturnLeftIcon: pe,
  ArrowUturnRightIcon: me,
  ArrowUturnUpIcon: xe,
  ArrowsPointingInIcon: fe,
  ArrowsPointingOutIcon: Me,
  ArrowsRightLeftIcon: ke,
  ArrowsUpDownIcon: ze,
  AtSymbolIcon: _e,
  BackspaceIcon: Ce,
  BackwardIcon: Ae,
  BanknotesIcon: Be,
  Bars2Icon: Ve,
  Bars3BottomLeftIcon: $e,
  Bars3BottomRightIcon: He,
  Bars3CenterLeftIcon: Ie,
  Bars3Icon: Le,
  Bars4Icon: be,
  BarsArrowDownIcon: je,
  BarsArrowUpIcon: ye,
  Battery0Icon: De,
  Battery100Icon: Se,
  Battery50Icon: Fe,
  ...
  BoltIcon: Ge,
  BookOpenIcon: Oe,
  BookmarkSlashIcon: We,
  BookmarkSquareIcon: Xe,
  BookmarkIcon: Ne,
  BriefcaseIcon: Qe,
  BugAntIcon: Ke,
  BuildingLibraryIcon: Ye,
  BuildingOffice2Icon: Ze,
  BuildingOfficeIcon: Je,
  BuildingStorefrontIcon: er,
  CakeIcon: rr,
  CalculatorIcon: nr,
  CalendarDaysIcon: or,
  CalendarIcon: tr,
  CameraIcon: ar,
  ChartBarSquareIcon: lr,
  ChartBarIcon: cr,
  ChartPieIcon: ir,
  ChatBubbleBottomCenterTextIcon: dr,
  ChatBubbleBottomCenterIcon: hr,
  ChatBubbleLeftEllipsisIcon: ur,
  ChatBubbleLeftRightIcon: sr,
  ChatBubbleLeftIcon: vr,
  ChatBubbleOvalLeftEllipsisIcon: wr,
  ChatBubbleOvalLeftIcon: gr,
  CheckBadgeIcon: pr,
  CheckCircleIcon: mr,
  CheckIcon: xr,
  ChevronDoubleDownIcon: fr,
  ChevronDoubleLeftIcon: Mr,
  ChevronDoubleRightIcon: kr,
  ChevronDoubleUpIcon: zr,
  ChevronDownIcon: _r,
  ChevronLeftIcon: Cr,
  ChevronRightIcon: Ar,
  ChevronUpDownIcon: Br,
  ChevronUpIcon: Vr,
  CircleStackIcon: $r,
  ClipboardDocumentCheckIcon: Hr,
  ClipboardDocumentListIcon: Ir,
  ClipboardDocumentIcon: Lr,
  ClipboardIcon: br,
  ClockIcon: jr,
  CloudArrowDownIcon: yr,
  CloudArrowUpIcon: Dr,
  CloudIcon: Sr,
  CodeBracketSquareIcon: Fr,
  CodeBracketIcon: Pr,
  Cog6ToothIcon: Er,
  Cog8ToothIcon: Rr,
  CogIcon: Ur,
  CommandLineIcon: Tr,
  ComputerDesktopIcon: qr,
  CpuChipIcon: Gr,
  CreditCardIcon: Or,
  CubeTransparentIcon: Wr,
  CubeIcon: Xr,
  CurrencyBangladeshiIcon: Nr,
  CurrencyDollarIcon: Qr,
  CurrencyEuroIcon: Kr,
  CurrencyPoundIcon: Yr,
  CurrencyRupeeIcon: Zr,
  CurrencyYenIcon: Jr,
  CursorArrowRaysIcon: en,
  CursorArrowRippleIcon: rn,
  DevicePhoneMobileIcon: nn,
  DeviceTabletIcon: on,
  DocumentArrowDownIcon: tn,
  DocumentArrowUpIcon: an,
  DocumentChartBarIcon: ln,
  DocumentCheckIcon: cn,
  DocumentDuplicateIcon: dn,
  DocumentMagnifyingGlassIcon: hn,
  DocumentMinusIcon: un,
  DocumentPlusIcon: sn,
  DocumentTextIcon: vn,
  DocumentIcon: wn,
  EllipsisHorizontalCircleIcon: gn,
  EllipsisHorizontalIcon: pn,
  EllipsisVerticalIcon: mn,
  EnvelopeOpenIcon: xn,
  EnvelopeIcon: fn,
  ExclamationCircleIcon: Mn,
  ExclamationTriangleIcon: kn,
  EyeDropperIcon: zn,
  EyeSlashIcon: _n,
  EyeIcon: Cn,
  FaceFrownIcon: An,
  ...
  GiftIcon: Rn,
  GlobeAltIcon: Un,
  GlobeAmericasIcon: Tn,
  GlobeAsiaAustraliaIcon: qn,
  GlobeEuropeAfricaIcon: Gn,
  HandRaisedIcon: On,
  HandThumbDownIcon: Wn,
  HandThumbUpIcon: Xn,
  HashtagIcon: Nn,
  HeartIcon: Qn,
  HomeModernIcon: Kn,
  HomeIcon: Yn,
  IdentificationIcon: Zn,
  InboxArrowDownIcon: Jn,
  InboxStackIcon: e4,
  InboxIcon: r4,
  InformationCircleIcon: n4,
  KeyIcon: o4,
  LanguageIcon: t4,
  LifebuoyIcon: a4,
  LightBulbIcon: l4,
  ...
  LockClosedIcon: d4,
  LockOpenIcon: h4,
  MagnifyingGlassCircleIcon: u4,
  MagnifyingGlassMinusIcon: s4,
  MagnifyingGlassPlusIcon: v4,
  MagnifyingGlassIcon: w4,
  MapPinIcon: g4,
  MapIcon: p4,
  MegaphoneIcon: m4,
  MicrophoneIcon: x4,
  ...
  NoSymbolIcon: A4,
  PaintBrushIcon: B4,
  PaperAirplaneIcon: V4,
  PaperClipIcon: $4,
  PauseCircleIcon: H4,
  PauseIcon: I4,
  PencilSquareIcon: L4,
  PencilIcon: b4,
  PhoneArrowDownLeftIcon: j4,
  PhoneArrowUpRightIcon: y4,
  PhoneXMarkIcon: D4,
  PhoneIcon: S4,
  PhotoIcon: F4,
  PlayCircleIcon: P4,
  ...
  PlusIcon: q4,
  PowerIcon: G4,
  PresentationChartBarIcon: O4,
  PresentationChartLineIcon: W4,
  PrinterIcon: X4,
  PuzzlePieceIcon: N4,
  QrCodeIcon: Q4,
  QuestionMarkCircleIcon: K4,
  QueueListIcon: Y4,
  RadioIcon: Z4,
  ReceiptPercentIcon: J4,
  ReceiptRefundIcon: eo,
  RectangleGroupIcon: ro,
  RectangleStackIcon: no,
  RocketLaunchIcon: oo,
  RssIcon: to,
  ScaleIcon: ao,
  ScissorsIcon: lo,
  ...
  UsersIcon: Uo,
  VariableIcon: To,
  VideoCameraSlashIcon: qo,
  VideoCameraIcon: Go,
  ViewColumnsIcon: Oo,
  ViewfinderCircleIcon: Wo,
  WalletIcon: Xo,
  WifiIcon: No,
  WindowIcon: Qo,
  WrenchScrewdriverIcon: Ko,
  WrenchIcon: Yo,
  XCircleIcon: Zo,
  XMarkIcon: Jo
}, Symbol.toStringTag, { value: "Module" })), A = /* @__PURE__ */ z({
  __name: "BaseIcon",
  props: {
    name: null,
  ...
  setup(r) {
    const n = r, a = (d) => d.toLowerCase().replace(new RegExp(/[-_]+/, "g"), " ").replace(new RegExp(/[^\w\s]/, "g"), "").replace(
      new RegExp(/\s+(.)(\w*)/, "g"),
      (h, s, w) => `${s.toUpperCase() + w}`
    ).replace(new RegExp(/\w/), (h) => h.toUpperCase()), u = c(
      () => n.type === "solid" ? H3[`${a(n.name)}Icon`] : et[`${a(n.name)}Icon`]
    ), i = c(() => ({
      width: `${n.size}rem`,
      height: `${n.size}rem`
    }));
    return (d, h) => (o(), t("div", null, [
      (o(), x(D(l(u)), B({
        style: [l(i)]
      }, d.$attrs), null, 16, ["style"]))
    ]));
  }
});
var O = /* @__PURE__ */ ((r) => (r.xs = "xs", r.sm = "sm", r.md = "md", r.lg = "lg", r.xl = "xl", r))(O || {});
const F = {
  xs: {
...
var W = /* @__PURE__ */ ((r) => (r.default = "default", r.success = "success", r.error = "error", r.info = "info", r.warning = "warning", r))(W || {});
const P = {
  default: {
  ...
  success: {
    ...
    outlined: "text-green-500 bg-transparent border-2 border-green-500 hover:bg-green-500 hover:border-green-500 hover:text-white focus:ring-green-300"
  },
  error: {
    base: "text-white bg-red-500 border-2 border-red-500 hover:bg-red-600 hover:border-red-600 focus:ring-red-300",
    outlined: "text-red-500 bg-transparent border-2 border-red-500 hover:bg-red-500 hover:border-red-500 hover:text-white focus:ring-green-300"
  },
  info: {
    base: "text-white bg-blue-500 border-2 border-blue-500 hover:bg-blue-600 hover:border-blue-600 focus:ring-blue-300",
    outlined: "text-blue-500 bg-transparent border-2 border-blue-500 hover:bg-blue-500 hover:border-blue-500 hover:text-white focus:ring-green-300"
  },
  warning: {
  ...
  props: {
    ...
    size: { default: O.md },
    color: { default: W.default }
  },
  emits: ["click"],
  setup(r, { emit: n }) {
    const a = r, u = c(() => a.rounded ? "rounded-full" : ""), i = c(
      () => a.outlined ? P[a.color].outlined : ""
    ), d = c(() => a.size ? F[a.size].base : ""), h = c(() => a.size ? F[a.size].icon : ""), s = c(
      () => a.outlined ? "" : P[a.color].base
    ), w = c(
    ...
    return (p, v) => (o(), t("button", B(p.$attrs, {
      type: r.type,
      class: ["transition-all duration-200 text-center inline-flex items-center gap-4 focus:ring-2", [l(u), l(i), l(d), l(s), l(w)]],
      onClick: v[0] || (v[0] = (_) => n("click", _))
    }), [
      r.loading ? (o(), t(j, { key: 0 }, [
        (o(), t("svg", {
          "aria-hidden": "true",
          role: "status",
          class: m(["inline animate-spin", l(h)]),
          viewBox: "0 0 100 101",
          fill: "none",
          xmlns: "http://www.w3.org/2000/svg"
        }, [
  ...
  setup(r, { emit: n }) {
    const a = r, u = N(), i = Q(!1), d = c(() => {
      let k = "div";
      return u.to && (k = "RouterLink"), u.href && (k = "a"), k;
    }), h = c(() => a.rounded ? "rounded" : ""), s = c(
      () => a.roundedFull ? "rounded-full" : ""
    ), w = c(
      () => a.outlined ? b[a.color].outlined : ""
    ), M = c(() => a.size ? E[a.size].base : ""), g = c(() => a.size ? E[a.size].icon : 1.25), p = c(
      () => a.outlined ? "" : b[a.color].base
    ), v = c(
      () => a.disabled ? "cursor-not-allowed bg-gray-600 opacity-20 border-0 !text-gray-200 hover:bg-gray-600" : ""
    ), _ = c(
      () => a.link && !a.disabled ? b[a.color].link : ""
    );
    return (k, V) => i.value ? f("", !0) : (o(), x(D(l(d)), B({ key: 0 }, k.$attrs, {
      ...
      default: K(() => [
        r.iconLeft ? (o(), x(A, {
          ...
          onClick: V[0] || (V[0] = (H) => n("click-left", H))
        ...
        r.iconRight ? (o(), x(A, {
          ...
          size: l(g),
          class: "cursor-pointer",
          onClick: V[1] || (V[1] = (H) => n("click-right", H))
        }, null, 8, ["name", "size"])) : f("", !0)
      ]),
      _: 3
    }, 16, ["class"]));
  ...
  ({ ...at, ...n }).autoImport.components && Object.entries({ ...lt }).forEach(([u, i]) => {
    r.component(u, i);
  });
};
export {
  e0 as BaseAvatar,
  o0 as BaseAvatarGroup,
  l0 as BaseBadge,
  ot as BaseButton,
  A as BaseIcon,
  tt as BaseTag,
